...
[Coinsnap](https://coinsnap.io/) for Paid Memberships Pro allows you to process Bitcoin Lightning payments over the Lightning network. 
...
* **All you need is a Lightning Wallet with a Lightning address.**
...
Follow updates on plugin's GitHub page: [https://github.com/Coinsnap/Coinsnap-for-PaidMembershipsPro/](https://github.com/Coinsnap/Coinsnap-for-PaidMembershipsPro/)

== Frequently Asked Questions ==

Plugin's page on Coinsnap website: [https://coinsnap.io/wp-add-ons/paid-memberships-pro/](https://coinsnap.io/wp-add-ons/paid-memberships-pro/)

== Screenshots ==

1. Install the Bitcoin payments for Paid Memberships Pro Plugin in WordPress
2. Activate plugin!
3. Go to Settings and choose Payments, choose Coinsnap
4. Coinsnap gateway settings
5. BTCPay gateway settings
6. If you have chosen BTCPay server, you can get API Key and Store ID using Setup Wizard: choose your store
7. Put label for your site
8. Coinsnap register
9. E-mail address confirmation
10. Connect website with Coinsnap
11. Coinsnap QR code on the Bitcoin payment page
12. Coinsnap invoice paid successfully
13. BTCPay server QR code on the Bitcoin payment page
14. BTCPay server invoice paid successfully
...
= 1.0.2 :: 2025-12-04 =
* Compatibility with Paid Memberships Pro 3.6.2 is tested.	
* Compatibility with Wordpress 6.9 is tested.

= 1.0.3 :: 2025-12-28 =
* Compatibility with Paid Memberships Pro 3.6.3 is tested.
